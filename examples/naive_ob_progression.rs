...
fn main() {
    ...
    let orderbook = Orderbook::synthetize(bid_price, ask_price,
    ...
    println!("pre-mid_price {}", (n_orderbooks[0].bids[0].price + 
        n_orderbooks[0].asks[0].price) / 2.0 );
    ...
    for i in 0..=3 {
        ...
        let i_orderbook = Orderbook::synthetize(i_bid_price - i_ret_gbm_bids, 
